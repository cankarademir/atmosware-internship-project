...
import com.cankarademir.atmosware_internship_project.ui.favorite.FavoriteFragmentDirections
import com.cankarademir.atmosware_internship_project.ui.photos.PhotosFragmentDirections

class FavoriteAdapter(private val dataList: List<Photos>) :
    ...
    class ViewHolder(itemView: View, private val dataList: List<Photos>) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener {
                ...
                val action = FavoriteFragmentDirections.actionNavigationFavoritesToDetailPhotoFragment(data)
